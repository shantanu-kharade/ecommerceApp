                        ...
                        <div className='space-y-8'>
                            <div>
                                <div className='flex items-center gap-3 mb-4'>
                                    <span className='inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-teal-50 text-teal-700 uppercase tracking-wide border border-teal-100'>
                            ...
                            <div className='flex flex-col sm:flex-row gap-6 items-center'>
                                ...
                                <div className='w-full sm:w-auto'>
                                    ...
                                    <div className='flex items-center bg-gray-50 border border-gray-200 rounded-xl p-1 w-fit'>
                                        <button
                                            ...
                                            className='w-10 h-10 flex items-center justify-center text-gray-600 hover:text-teal-600 hover:bg-white rounded-lg transition-all shadow-sm font-bold text-lg'
                                        >
                                            −
                                        </button>
                                        <input
                                ...
                                <div className='flex-1 w-full'>
                                    ...
                                    <button
                                        ...
                                        className='w-full px-8 py-3.5 bg-gradient-to-r from-teal-600 to-cyan-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-teal-200 transition-all duration-200 transform hover:scale-[1.02] flex items-center justify-center cursor-pointer gap-2 text-lg'
                                    >

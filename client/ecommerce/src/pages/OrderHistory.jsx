            ...
            <div className="max-w-7xl mx-auto px-4 py-8 mt-8">
                ...
                {orders.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-20 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl border border-gray-200">
                        ...
                        <a
                            href="/products"
                            className="px-6 py-2.5 bg-gradient-to-r from-teal-600 to-cyan-600 text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-teal-200 transition-all"
                        >
                            Continue Shopping
                        </a>
                    </div>
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex items-center gap-6">
                                        <div>
                                            ...
                                            <p className="text-lg font-semibold text-teal-600">₹{order.totalAmount || 0}</p>
                                        </div>
                                        <div>

            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="bg-white rounded-3xl shadow-xl shadow-gray-100 overflow-hidden flex flex-col md:flex-row min-h-[600px] border border-gray-100">
                    ...
                    <div className="w-full md:w-2/3 p-8 md:p-12 flex flex-col gap-6">
                        ...
                        <div className="pt-4">
                            <button className="w-full py-3.5 bg-gradient-to-r from-teal-600 to-cyan-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-teal-200 transition-all duration-200 transform hover:scale-[1.01]">
                                Update Profile
                            </button>
                        </div>

        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="px-4 md:px-8 lg:px-20 py-12">
                ...
                <div className="max-w-7xl mx-auto mb-12 text-center md:text-left">
                    <h1 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-cyan-600 mb-3">
                        Our Collections
                    </h1>
                    ...
                    <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                        <button
                            ...
                            className={`px-6 py-2.5 rounded-full font-semibold transition-all duration-300 transform hover:-translate-y-0.5 ${activeCategory === "all"
                                ? "bg-gradient-to-r from-teal-600 to-cyan-600 text-white shadow-lg shadow-teal-200 scale-105"
                                : "bg-white text-gray-600 border border-gray-200 hover:border-teal-600 hover:text-teal-600 hover:shadow-md"
                                }`}
                        >
                            All Products
                        </button>
                    ...
                    {loading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-32 bg-white rounded-3xl shadow-sm border border-gray-100 text-center px-4">
                            ...
                            <p className="text-gray-500 max-w-md mx-auto">
                                We couldn't find any items in the <span className="font-semibold text-teal-600">{activeCategory}</span> category.
                            </p>
                            <button
                                onClick={() => {
                                    setAllProducts(products)
